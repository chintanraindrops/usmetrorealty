...
class ipropertyController extends JControllerLegacy
{
    ...
    public function fetchoregonfromrets(){
        ...
        // pull in the packages managed by Composer
        require_once(JPATH_SITE."/rets/rets/vendor/autoload.php");
