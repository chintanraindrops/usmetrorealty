...
<div class="navbar">
    <div class="navbar-inner">
        ...
        <ul class="nav">
            ...
            ?>
            <li <?php  if($view == 'searchcriteriaform' || $layout == 'searchcriterialist') echo 'class="active"'; ?>> <a href="<?php echo $search_criteria_link; ?>">Search Criteria</a></li>
            <?php } ?>
            <li<?php if($layout == 'proplist' || $layout == 'sellerproplist' || $layout == 'buyerproplist' || $view == 'allproperties') echo ' class="active"'; ?>>
                <?php if($agent_type==1){ ?>
