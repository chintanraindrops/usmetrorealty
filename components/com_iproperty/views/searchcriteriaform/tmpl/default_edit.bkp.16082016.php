...
<form action="index.php?option=com_iproperty&view=searchcriteriaform" method="post" name="adminForm" id="adminForm" class="form-validate ipform form-horizontal" enctype="multipart/form-data">
        ...
        <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                         <input type="text" name="jform[minprice]" id="jform_minprice" class="inputbox checkint" required="required" size="50" value="<?php echo $data->minprice?>">
                        &nbsp;<?php echo "To"; ?>&nbsp;
                         <input type="text" name="jform[maxprice]" required="required" id="jform_maxprice" class="inputbox checkint" size="50" value="<?php echo $data->maxprice?>">
                    </div>
                </div>
                <div class="control-group">
                    <div class="control-label">
                    ...
                    <div class="controls">
                        ...
                        <select aria-required="true" required="required" multiple="" size="50" class="inputbox required chzn-done" name="jform[country][]" id="jform_country">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <select aria-required="true" required="required" multiple="" size="10" class="inputbox region required" name="jform[locstate][]" id="jform_locstate">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <select aria-required="true" required="required" multiple="" size="50" class="inputbox city required chzn-done" name="jform[city][]" id="jform_city">
            ...
            <fieldset>
                ...
                <div class="row-fluid">
                    <div class="span6 pull-left form-vertical">
                        <div class="control-group">
                            <div class="control-label">
                                <label><?php echo JText::_('COM_IPROPERTY_BEDS_DESIRED'); ?></label>
                            </div>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <div class="control-label">
                               <label><?php echo JText::_('COM_IPROPERTY_BATHS_DESIRED'); ?></label>
                            </div>
                            <div class="controls">
                   ...
                   <div class="span6 pull-right form-vertical">
                        <div class="control-group">
                            <div class="control-label">
                                <label><?php echo JText::_('COM_IPROPERTY_GARAGE_SIZE'); ?></label>
                            </div>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <fieldset class="btn-group btn-group-yesno radio" id="jform_reo">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <fieldset class="btn-group btn-group-yesno radio" id="jform_hoa">
