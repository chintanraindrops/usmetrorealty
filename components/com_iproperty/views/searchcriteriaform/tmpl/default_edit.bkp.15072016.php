...
<form action="index.php?option=com_iproperty&view=searchcriteriaform" method="post" name="adminForm" id="adminForm" class="form-validate ipform form-horizontal" enctype="multipart/form-data">
        <div class="btn-toolbar">
            <div class="btn-group">
                ...
                <button type="button" class="btn" value="cancel" name="save" onclick="window.location.href='index.php?option=com_iproperty&view=manage&layout=buyerproplist';">
        ...
        <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <select id="jform_locstate" name="jform[locstate]" class="inputbox required" size="1" required="" aria-required="true">
                                <option value="">Select State</option>
                                <?php foreach ($this->State as $value) { ?> 
                                   <option <?php if($data->locstate == $value->id) { echo 'selected="selected"'; } ?> value="<?php echo $value->id;?>"><?php echo $value->title; ?></option>
                                <?php } ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="span4 pull-left">
                    <span class="spacer">
                        ...
                        <div class="alert alert-success">
                            <h3 id="jform_general_amen_header-lbl" class="visible-first visible">General Amenities</h3>
                        </div>
                ...
                <div class="span4 pull-left">
                    <span class="spacer">
                        ...
                        <div class="alert alert-info">
                            <h3 id="jform_interior_amen_header-lbl" class="visible-first visible">Interior Amenities</h3>
                        </div>
                        <span class="after"></span>
                    </span>
                ...
                <div class="span4 pull-left">
                    <span class="spacer">
                        ...
                        <div class="alert alert-error">
                            <h3 id="jform_exterior_amen_header-lbl" class="visible-first visible">Exterior Amenities</h3>
                        </div>
                        <span class="after"></span>
                    </span>
            ...
            <div class="row-fluid">
                <div class="span4 pull-left">
                    <span class="spacer">
                        <span class="before"></span>
                        <div class="alert alert-success">
                            <h3 id="jform_accessibility_amen_header-lbl" class="visible-first">Accessibility Amenities</h3>
                        </div>
                        <span class="after"></span>
                    </span>
                ...
                <div class="span4 pull-left">
                    <span class="spacer">
                        <span class="before"></span>
                        <div class="alert alert-info">
                            <h3 id="jform_green_amen_header-lbl" class="visible-first">Energy Savings Amenities</h3>
                        </div>
                        <span class="after"></span>
                    </span>
                ...
                <div class="span4 pull-left">
                    <span class="spacer">
                        <span class="before"></span>
                        <div class="alert alert-error">
                            <h3 id="jform_security_amen_header-lbl" class="visible-first">Security Amenities</h3>
                        </div>
                        <span class="after"></span>
                    </span>
            ...
            <div class="row-fluid">
                <div class="span4 pull-left">
                    <span class="spacer">
                        <span class="before"></span>
                        <div class="alert alert-success">
                            <h3 id="jform_landscape_amen_header-lbl" class="visible-first">Landscape Amenities</h3>
                        </div>
                        <span class="after"></span>
                    </span>
                ...
                <div class="span4 pull-left">
                    <span class="spacer">
                        <span class="before"></span>
                        <div class="alert alert-info">
                            <h3 id="jform_community_amen_header-lbl" class="visible-first">Community Amenities</h3>
                        </div>
                        <span class="after"></span>
                    </span>
                ...
                <div class="span4 pull-left">
                    <span class="spacer">
                        <span class="before"></span>
                        <div class="alert alert-error">
                            <h3 id="jform_appliance_amen_header-lbl" class="visible-first">Appliance Amenities</h3>
                        </div>
                        <span class="after"></span>
                    </span>
